...
from mvtec_data_maker import MVTEC
...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str, default='/kaggle/input/mvtec-ad')
    parser.add_argument('--save_path', type=str, default='./mvtec_result')
    parser.add_argument('--arch', type=str, choices=['resnet18'], default='resnet18')
...
def default():
    ...
    shrink_factors = [1, 0.8, 0.98, 0.95, 0.9, 0.85, 1]
